...
![tags-solved](docs/screenshot-tags.png)

## Screenshots

| Tags Solved | Statistics Summary | Problem Ratings |
|---|---|---|
| ![tags](docs/screenshot-tags.png) | ![stats](docs/screenshot-stats.png) | ![ratings](docs/screenshot-ratings.png) |
...
- 🌓 **Dark / Light Theme Toggle** — switch between Neo Glass Dark and Neo Glass Light
